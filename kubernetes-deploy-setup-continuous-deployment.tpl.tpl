...
kind: Ingress
  metadata:
    ...
    annotations:
      [external-dns.alpha.kubernetes.io/set-identifier:](http://external-dns.alpha.kubernetes.io/set-identifier:) prototype-ingress-${BRANCH}-${KUBE_NAMESPACE}-green
      [external-dns.alpha.kubernetes.io/aws-weight:](http://external-dns.alpha.kubernetes.io/aws-weight:) "100"
  spec:
